...
local function createRunePanel()
    -- Wide and short panel: 3 columns x 3 rows
    runePanel = Instance.new("Frame")
    runePanel.Name = "RunePanel"
    runePanel.Size = UDim2.new(0, 440, 0, 255)
    runePanel.Position = UDim2.new(0.5, -220, 0.5, -128)
    ...
    -- 3 x 3 grid. This keeps the panel wide instead of making it tall.
    runeScroll = Instance.new("ScrollingFrame")
    runeScroll.Size = UDim2.new(1, -20, 0, 155)
    runeScroll.Position = UDim2.new(0, 10, 0, 40)
    runeScroll.BackgroundColor3 = Color3.fromRGB(39, 34, 57)
    runeScroll.BackgroundTransparency = 0.15
    runeScroll.BorderSizePixel = 0
    runeScroll.ScrollBarThickness = 3
    ...
    runeScroll.ScrollingDirection = Enum.ScrollingDirection.Y
    runeScroll.ZIndex = 51
    runeScroll.Parent = runePanel
    corner(runeScroll, 8)

    local grid = Instance.new("UIGridLayout")
    grid.CellSize = UDim2.new(0, 132, 0, 45)
    grid.CellPadding = UDim2.new(0, 6, 0, 6)
    grid.HorizontalAlignment = Enum.HorizontalAlignment.Center
    grid.VerticalAlignment = Enum.VerticalAlignment.Top
    grid.SortOrder = Enum.SortOrder.LayoutOrder
    grid.Parent = runeScroll
    ...
    for i, rune in ipairs(runes) do
        ...
        -- Normal square checkbox with a standard checkmark.
        local check = Instance.new("TextLabel")
        check.Name = "Check"
        check.Size = UDim2.new(0, 24, 0, 24)
        check.Position = UDim2.new(1, -29, 0.5, -12)
    ...
    selectAll.Size = UDim2.new(0, 195, 0, 38)
    selectAll.Position = UDim2.new(0, 10, 1, -48)
    ...
    clear.Size = UDim2.new(0, 195, 0, 38)
    clear.Position = UDim2.new(0, 235, 1, -48)
    clear.Text = "CLEAR"
